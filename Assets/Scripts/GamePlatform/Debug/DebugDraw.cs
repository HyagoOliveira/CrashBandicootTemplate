...
public static class DebugDraw
{
	...
	public static void DrawVectorHit (Vector3 origin, Vector3 direction, RaycastHit hit, float markerSize = 1f, float duration = 0f, bool depthTest = true)
	{
		DrawVector (origin, direction, hit.distance, markerSize, Color.red, duration, depthTest);
	}
}
